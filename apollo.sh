...
#    BUILD_TARGETS=`bazel query //modules/... union //cyber/...`
    ...
    BUILD_TARGETS=`bazel query //modules/... union //cyber/... union //modules/tools/visualizer/... except //modules/v2x/... except //modules/map/tools/map_datachecker/... $DISABLE_CYBER_MODULES`
  esac
