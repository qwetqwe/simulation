...
void PerceptionCameraUpdater::Start() { enabled_ = true; AINFO<<"START PERCEPTION CAMERA UPDATER";}
...
void PerceptionCameraUpdater::GetLocalization2CameraTF(
  ...
  {
    AWARN<<"can not get locaization to novatel tf";
  }
  ...
  {
    AWARN<<"can not get velodyne128 to novatel tf";
  }
  ...
  {
    AWARN<<"can not get velodyne to front_6mm tf";
  }
