...
DEFINE_string(list, "/apollo/modules/perception/testdata/camera/app/lane_images/test.list", "test file title");
DEFINE_string(file_title, "", "test file title");
DEFINE_string(debug_file, "", "debug file title");
DEFINE_string(save_dir, "/apollo/result/", "test file title");
DEFINE_string(file_ext_name, ".jpg", "file extension name");
