...
int lane_postprocessor_eval() {
  ...
  postprocessor_init_options.detect_config_root = "/apollo/modules/perception/testdata/camera/lib/lane/postprocessor/denseline/data";
