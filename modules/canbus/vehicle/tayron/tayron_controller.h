...
class TayronController final : public VehicleController {
 public:

  explicit TayronController() {};

  virtual ~TayronController();
  ...
  FRIEND_TEST(TayronControllerTest, SetDrivingMode);
  FRIEND_TEST(TayronControllerTest, Status);
  FRIEND_TEST(TayronControllerTest, UpdateDrivingMode);
 private:
 ...
 private:
  // control protocol
  Brakecmd214* brake_cmd_214_ = nullptr;
  Gascmd216* gas_cmd_216_ = nullptr;
  Shiftcmd217* shift_cmd_217_ = nullptr;
  Steeringcmd215* steering_cmd_215_ = nullptr;
