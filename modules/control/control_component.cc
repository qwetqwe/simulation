...
bool ControlComponent::Proc() {
  ...
  if (FLAGS_use_navigation_mode) {
    localization_msg->mutable_pose()->mutable_position()->set_x(0);
    localization_msg->mutable_pose()->mutable_position()->set_y(0);
    localization_msg->mutable_pose()->mutable_position()->set_z(0);
    localization_msg->mutable_pose()->set_heading(0);
  }
