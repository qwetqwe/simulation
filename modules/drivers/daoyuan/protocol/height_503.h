...
#ifndef MODULES_CANBUS_VEHICLE_ctrek_PROTOCOL_height_503_H_
#define MODULES_CANBUS_VEHICLE_ctrek_PROTOCOL_height_503_H_
 ...
 */
class Height503 : public ::apollo::drivers::canbus::ProtocolData<Daoyuan> {
 public:
 ...
 private:
    ...
    double height(const std::uint8_t *bytes,
                                  int32_t length) const;  
   double time(const std::uint8_t *bytes,
                                  int32_t length) const;                           
};
